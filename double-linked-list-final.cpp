...
void insertFirst(int element)
{
  ...
  else
  {
    ...
    head->prev = newItem;
    head = newItem;
    printf("Data Berhasil Ditambahkan Didepan");
  }
}
...

{
  ...
  while (1)
  {
    ...
    printf("\n>>>>>Double Linked List Program<<<<<\n1.Tambah Data Depan \n2.Tambah Data Belakang \n3.Tambah Data Tengah Setelah  \n4.Tambah Data Tengah Sebelum \n5.Hapus Data Depan \n6.Hapus Data Belakang \n7.Pilih Data Yang Akan Dihapus \n8.Exit");
    cout << "\n\nMasukkan pilihan=";
    cin >> choice;
    if (choice == 1)
    {
      ...
      insertFirst(element);
      printList();
      printf("\n*****Data Depan Berhasil Diambahkan*****\n");
    }
    else if (choice == 2)
    {
      int element;
      ...
      insertLast(element);
      printList();
      printf("\n*****Data Belakang Berhasil Diambahkan*****\n");
    }
    else if (choice == 3)
    {
      int old, newitem;
      ...
      printList();
      printf("\n*****Data Setelah Node ke-");
      printf("%i",old); 
      printf(" Berhasil Diambahkan*****\n");
    ...
    {
       printf("*****Program Berhasil Keluar*****");
      return 0;
    }
    else
    {
      printf("\nInput salah, silahkan coba input angka lain\n");
    }
  }
  return 0;
}